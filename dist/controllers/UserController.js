...
export class UserController {
    ...
    static async login(req, res) {
        try {
            ...
            const token = jwt.sign({ national_code: user.national_code }, process.env.JWT_SECRET || "jahad_secret", { expiresIn: "1YEAR" });
    ...
    static async completeProfile(req, res) {
        try {
            ...
            const { postal_code, landline_phone, address, province, city } = req.body;
