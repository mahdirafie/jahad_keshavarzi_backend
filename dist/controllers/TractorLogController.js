...
export class TractorLogController {
     ...
     */
    static async createTractorLog(req, res) {
        try {
            ...
            for (const log of logs) {
                const { pass, tractor_id, sent_at, lat, lon, distance, in_fuel, out_fuel, rpm, cell_signal, temp, retry_count, packet_day, packet_hour, } = log;
                // Password check
                if (pass !== "123456") {
                    return res
                        .status(403)
    ...
    static async getAllLogsForTractor(req, res) {
        try {
...
//# sourceMappingURL=TractorLogController.js.map